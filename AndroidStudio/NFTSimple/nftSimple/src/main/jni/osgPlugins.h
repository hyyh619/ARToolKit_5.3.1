...
// osgPlugins.h
//
// This file is required when using a statically-linked version of OSG.
// It defines the graphics window implementation, the wrappers to use
// to load various OpenSceneGraph entities, and the plugins which should
// be loaded statically.
//
// To make use of osgPlugins.h, include it in your project, and link against
// the used OpenSceneGraph libraries and plugins.
//
