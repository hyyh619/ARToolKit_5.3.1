...
PIXELFORMAT StringToPX(char *formatName)
{
    for (unsigned int i = 0; i < PIXELFORMAT_ENUM_MAX; i++)
        if (strcmp(formatName, PIXELFORMAT_names[i]) == 0)
