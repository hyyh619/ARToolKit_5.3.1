...
ANDROID_SDK_TOOLS_DIR="C:/Users/Administrator/AppData/Local/Android/sdk/tools"
NDK="C:/Users/Administrator/AppData/Local/Android/sdk/ndk-bundle"
...
#
echo $NDK/ndk-build$NDK_BUILD_SCRIPT_FILE_EXT -j $CPUS $1
...
# Built elements are moved to ./libs folder
#
echo $NDK/ndk-build$NDK_BUILD_SCRIPT_FILE_EXT -j $CPUS NDK_APPLICATION_MK=jni/Application-ARWrapper.mk $1
