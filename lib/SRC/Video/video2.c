...
static int ar2VideoGetDeviceWithConfig(const char *config, const char **configStringFollowingDevice_p)
{
    ...
    if (configStringFollowingDevice_p)
        *configStringFollowingDevice_p = NULL;
    ...
    if (a)
    {
        for (;;)
        {
            ...
            else if (strcmp(b, "-device=WinDSVL") == 0)
            {
                ...
                if (configStringFollowingDevice_p)
                    *configStringFollowingDevice_p = a;
            }
    ...
    if (configStringFollowingDevice_p)
    {
        if (*configStringFollowingDevice_p)
        {
            while (**configStringFollowingDevice_p != ' ' && **configStringFollowingDevice_p != '\t' && **configStringFollowingDevice_p != '\0')
                (*configStringFollowingDevice_p)++;

            while (**configStringFollowingDevice_p == ' ' || **configStringFollowingDevice_p == '\t')
                (*configStringFollowingDevice_p)++;
        }
        else
        {
...
AR2VideoParamT* ar2VideoOpen(const char *config_in)
{
    ...
    {
#ifdef AR_INPUT_DUMMY
        if ((vid->device.dummy = ar2VideoOpenDummy(config)) != NULL)
            return vid;
    ...
    {
#ifdef AR_INPUT_V4L
        if ((vid->device.v4l = ar2VideoOpenV4L(config)) != NULL)
            return vid;
    ...
    {
#ifdef AR_INPUT_V4L2
        if ((vid->device.v4l2 = ar2VideoOpenV4L2(config)) != NULL)
            return vid;
    ...
    {
#ifdef AR_INPUT_DV
        if ((vid->device.dv = ar2VideoOpenDv(config)) != NULL)
            return vid;
    ...
    {
#ifdef AR_INPUT_1394CAM
        if ((vid->device.cam1394 = ar2VideoOpen1394(config)) != NULL)
            return vid;
    ...
    {
#ifdef AR_INPUT_GSTREAMER
        if ((vid->device.gstreamer = ar2VideoOpenGStreamer(configStringFollowingDevice)) != NULL)
            return vid;
    ...
    {
#ifdef AR_INPUT_SGI
        if ((vid->device.sgi = ar2VideoOpenSGI(config)) != NULL)
            return vid;
    ...
    {
#ifdef AR_INPUT_WINDOWS_DIRECTSHOW
        if ((vid->device.winDS = ar2VideoOpenWinDS(config)) != NULL)
            return vid;
    ...
    {
#ifdef AR_INPUT_WINDOWS_DSVIDEOLIB
        if ((vid->device.winDSVL = ar2VideoOpenWinDSVL(configStringFollowingDevice)) != NULL)
            return vid;
    ...
    {
#ifdef AR_INPUT_WINDOWS_DRAGONFLY
        if ((vid->device.winDF = ar2VideoOpenWinDF(config)) != NULL)
            return vid;
    ...
    {
#ifdef AR_INPUT_QUICKTIME
        if ((vid->device.quickTime = ar2VideoOpenQuickTime(config)) != NULL)
            return vid;
    ...
    {
#ifdef AR_INPUT_IPHONE
        if ((vid->device.iPhone = ar2VideoOpeniPhone(config)) != NULL)
            return vid;
    ...
    {
#ifdef AR_INPUT_QUICKTIME7
        if ((vid->device.quickTime7 = ar2VideoOpenQuickTime7(config)) != NULL)
            return vid;
    ...
    {
#ifdef AR_INPUT_IMAGE
        if ((vid->device.image = ar2VideoOpenImage(config)) != NULL)
            return vid;
    ...
    {
#ifdef AR_INPUT_ANDROID
        if ((vid->device.android = ar2VideoOpenAndroid(config)) != NULL)
            return vid;
    ...
    {
#ifdef AR_INPUT_WINDOWS_MEDIA_FOUNDATION
        if ((vid->device.winMF = ar2VideoOpenWinMF(config)) != NULL)
            return vid;
    ...
    {
#ifdef AR_INPUT_WINDOWS_MEDIA_CAPTURE
        if ((vid->device.winMC = ar2VideoOpenWinMC(config)) != NULL)
            return vid;
...
#ifdef AR_INPUT_IPHONE
        if (callback)
            vid->device.iPhone = ar2VideoOpenAsynciPhone(config, callback, userdata);
        else
            vid->device.iPhone = NULL;

        if (vid->device.iPhone != NULL)
            return vid;
