                                   ...
                                   ARdouble width, ARdouble conv[3][4])
{
    ...
    if (icpStereoPoint(handle->icpStereoHandle, &data, matXw2C, conv, &err) < 0)
        return 100000000.0;
                                       ...
                                       ARdouble width, ARdouble conv[3][4])
{
    ...
    if (data.numL == 0 && data.numR == 0)
        return 100000000.0;

    if (icpStereoPoint(handle->icpStereoHandle, &data, prev_conv, conv, &err) < 0)
        return 100000000.0;
                             ...
                             ARdouble conv[3][4])
{
    ...
    if (icpStereoPoint(handle->icpStereoHandle, &data, initConv, conv, &err) < 0)
        return 100000000.0;
                                   ...
                                   ARdouble conv[3][4])
{
    ...
    if (icpStereoPointRobust(handle->icpStereoHandle, &data, initConv, conv, &err) < 0)
        return 100000000.0;
