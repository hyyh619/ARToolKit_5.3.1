 ...
 */
inline const std::vector<Image>&images() const
{
    return mImages;
}
 ...
 */
inline Image&get(size_t index)
{
    return mImages[index];
}
inline const Image&get(size_t index) const
{
    return mImages[index];
}
 ...
 */
inline int numOctaves() const
{
    return mNumOctaves;
}
inline int numScalePerOctave() const
{
 ...
 */
inline int scaleFromIndex(int index) const
{
    return index % mNumScalesPerOctave;
}
 ...
 */
inline const std::vector<FeaturePoint>&features() const
{
 ...
 * @return DoG Pyramid
 */
inline const DoGPyramid&dogPyramid() const
{
    return mLaplacianPyramid;
}
