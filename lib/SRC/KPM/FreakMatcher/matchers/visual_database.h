 ...
 * @return Query store
 */
const keyframe_ptr_t queryKeyframe() const
{
    return mQueryKeyframe;
}

const size_t databaseCount() const
{
    return mKeyframeMap.size();
}
 ...
 */
const FEATURE_EXTRACTOR&featureExtractor() const
{
...
{
    return mMatchedInliers;
}

/**
 * Get the mathced id.
 */
inline id_t matchedId() const
{
    return mMatchedId;
}
 ...
 */
const float* matchedGeometry() const
{
    return mMatchedGeometry;
}

/**
 * Get the detector.
 */
inline detector_t&detector()
{
    return mDetector;
}
inline const detector_t&detector() const
{
    return mDetector;
}
 ...
 */
inline void setMinNumInliers(size_t n)
{
    mMinNumInliers = n;
}
inline size_t minNumInliers() const
{
    return mMinNumInliers;
}
