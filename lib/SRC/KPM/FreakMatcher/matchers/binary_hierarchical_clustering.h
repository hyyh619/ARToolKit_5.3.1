 ...
 */
inline unsigned int dist() const
{
    return mDistance;
}
 ...
 * @return Get children
 */
inline std::vector<node_t*>&children()
{
    return mChildren;
}
inline const std::vector<node_t*>&children() const
{
    return mChildren;
}
 ...
 */
inline std::vector<int>&reverseIndex()
{
    return mReverseIndex;
}
inline const std::vector<int>&reverseIndex() const
{
    return mReverseIndex;
}
...
inline int numHypotheses() const
{
    return mBinarykMedoids.numHypotheses();
}

/**
 * Set/Get number of center.
 */
inline void setNumCenters(int k)
{
    mBinarykMedoids.setk(k);
}
inline int numCenters() const
{
    return mBinarykMedoids.k();
}

/**
 * Set/Get max nodes to pop from queue.
 */
inline void setMaxNodesToPop(int n)
{
    mMaxNodesToPop = n;
}
inline int maxNodesPerPop() const
{
    return mMaxNodesToPop;
}

/**
 * Set/Get minimum number of features per node.
 */
inline void setMinFeaturesPerNode(int n)
{
    mMinFeaturePerNode = n;
}
inline int minFeaturesPerNode() const
{
    return mMinFeaturePerNode;
}
